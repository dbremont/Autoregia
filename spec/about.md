...
| **MAD** | Memory Aid System (MAD) | Perception | Externalizes internal & environmental state for persistent recording, discovery, and retrieval — the sense organs of the loop. |
