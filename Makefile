...
test: ## pytest ces + wos + gis + acsms suites (needs CouchDB on 127.0.0.1:5984)
	python3 -m pytest app/module/ate/tool/ces/test_ces.py app/module/wos/test_wos.py app/module/gis/test_gis.py app/module/acsms/test_acsms.py
