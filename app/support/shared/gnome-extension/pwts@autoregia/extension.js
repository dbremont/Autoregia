// Autoregia PWTS Focus Bridge — GNOME Shell extension (45/46/47, ESM).
//
// Exposes the focused window over the session D-Bus so the PWTS collector
...
export default class PWTSFocusExtension {
    enable() {
        ...
        this._owner = Gio.DBus.session.own_name(
            ...
            () => log('[pwts@autoregia] D-Bus name acquired: ' + BUS_NAME),
            () => log('[pwts@autoregia] D-Bus name lost: ' + BUS_NAME));
    }
