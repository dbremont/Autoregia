"""WOS semantic clustering.

Groups observations into semantic clusters. Two backends:
...
The chosen backend is auto-detected (overridable via ``WOS_CLUSTER_BACKEND``).
...
from wos.analytics import _text, tokenize

_BACKEND = os.environ.get("WOS_CLUSTER_BACKEND", "auto").lower()
