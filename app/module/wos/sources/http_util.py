"""Small HTTP + parsing helpers shared by WOS source modules."""
...
# WOS_USER_AGENT for feeds that ask for a descriptive identifier.
USER_AGENT = os.environ.get(
    "WOS_USER_AGENT",
    "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) "
    "Chrome/124.0 Safari/537.36 Autoregia-WOS/0.1",
)
