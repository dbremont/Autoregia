"""
AOOS Analytics Dashboard — deterministic Todoist-style dataset generator.

Produces a synthetic `app.todoist`-shaped dataset that the Analytics Dashboard
(spec/aoos/analytics.md) computes over. Fake by design: realistic seasonality,
...
Run:    python3 aoos/data/gen_todoist_mock.py
"""
import json
import os
import random
