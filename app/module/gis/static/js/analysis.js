/* GIS Analysis — Statistical Overlay (coverage, gaps, redundancy, dependency, cost, freshness, health, trust) */
PT.Analysis = {
  _charts: [],
  render() {
  ...
  async refresh() {
    let d;
    try { const r = await fetch('/gis/api/analysis'); d = await r.json(); }
