...
└── static/
    ...
    ├── css/               # design tokens & components (mirrors MAD, the reference impl)
...
The server listens on **port 5003** (MAD → 5000, PKTS → 5001/5002). The port can
...
Oxford aesthetic, shared design tokens (copied verbatim from the MAD reference
