...
spec/ptocs/schema.json: ~31 entries spanning every object_kind (including
document / language / person / project / other), with provenance, cost,
usage, epistemic, strategic metadata, a space assignment (personal / work /
projects), and a connected relationship graph (so dependency / redundancy /
capability-gap analysis has meaningful data).

Run:  python3 gis/data/gen_mock.py
Writes: gis/data/mock_entries.json
"""
import json, os
...
def E(id, name, kind, category, domain, status, priority, system,
      ...
      period=None, pinned=False, space="personal"):
...
ENTRIES = [
  ...
  E("OBJ-2026-0014","RFC 9110","reference_artifact","standard","Software Engineering","active","medium","system_4_intelligence","HTTP Semantics standard.","Normative reference for HTTP service design.","Defines HTTP methods, status codes, and semantics.","IETF","9110","BSD","https://www.rfc-editor.org/rfc/rfc9110","cloud","open","document","free","n/a","https://www.rfc-editor.org/rfc/rfc9110","https://www.rfc-editor.org/rfc/rfc9110","high","established",5,["standard","reference"],5,days(200),space="work"),
  E("OBJ-2026-0015","Release Pipeline","workflow_method","ci-cd","Software Engineering","active","high","system_1_operations","Automated build, test, and publish procedure.","Codify the path from commit to released artifact.","Run tests on push, build containers, deploy on tag.","self","v2","proprietary","https://github.com/autoregia/.github","cloud","oauth","api","maintenance","workflow YAML","internal","git tag && git push --tags","medium","observational",3.5,["automation"],3,days(150),space="work"),
  E("OBJ-2026-0016","Prompt Engineering","capability_skill","ai-skill","Software Engineering","active","high","system_4_intelligence","Method for eliciting reliable behaviour from LLMs.","Improve quality of AI-assisted catalog enrichment.","Compose structured prompts, few-shot examples, and constraints.","self","n/a","proprietary","internal notes","local","open","none","opportunity","n/a","internal","mental","high","experimental",4,["skill","ai"],0,days(100),space="work"),
  ...
  E("OBJ-2026-0024","Python","language","programming-language","Software Engineering","active","critical","system_1_operations","High-level programming language.","Primary language for Autoregia services and scripts.","General-purpose scripting, services, and data work.","Python Software Foundation","3.12","PSF-2.0","https://www.python.org","local","open","cli","free","system package","https://docs.python.org","python3","high","established",5,["language","daily-driver"],0,days(1500),pinned=True,space="work"),
  E("OBJ-2026-0025","Research Papers","document","paper-collection","Research","active","medium","system_4_intelligence","Academic papers and references.","Curated reading list backing the Intelligence System.","Stored PDFs and preprints with notes in the vault.","self","n/a","varies","https://arxiv.org","local","open","document","free","manual curation","internal","read & annotate","medium","observational",3.5,["research","papers","academic"],2,days(300)),
  E("OBJ-2026-0026","Dominican Republic Bonds","data_source","fixed-income","Finance","active","medium","system_5_policy","Fixed-income instruments and market data.","Track personal exposure to DR sovereign debt.","Yield, maturity, and price tracking for DR bonds.","Ministerio de Hacienda","n/a","public","https://www.hacienda.gob.do","cloud","open","web","free","browser","https://www.hacienda.gob.do","browser","medium","observational",3,["bonds","finance","dr"],1,days(150),space="work"),
  E("OBJ-2026-0027","Docker","infrastructure","containers","Software Engineering","active","high","system_1_operations","Containerization platform.","Package and ship Autoregia services reproducibly.","Build, run, and publish container images.","Docker Inc.","27","Apache-2.0","https://www.docker.com","self_hosted","freemium","cli","freemium","apt install docker.io","https://docs.docker.com","docker compose up","high","established",4.5,["containers","devops","infra"],0,days(400),space="work"),
  E("OBJ-2026-0028","AWS","service_platform","cloud-infrastructure","Infrastructure","backup","low","system_3_control","Cloud infrastructure and services.","Evaluate as off-site compute and storage.","Compute, object storage, and managed databases.","Amazon","n/a","proprietary","https://aws.amazon.com","cloud","subscription","web","subscription","console","https://docs.aws.amazon.com","console","low","anecdotal",3,["cloud","infra","aws"],60,days(120),currency="USD",amount=5.0,period="monthly",space="work"),
  E("OBJ-2026-0029","Figma","service_platform","design","Software Engineering","trial","low","system_1_operations","Collaborative design platform.","Mock-ups for Autoregia interface work.","Vector editing, prototyping, and design hand-off.","Figma Inc.","n/a","proprietary","https://www.figma.com","cloud","freemium","web","freemium","n/a","https://help.figma.com","https://figma.com","medium","anecdotal",3,["design","collaboration","ui"],30,days(45),currency="USD",amount=0.0,period="monthly",space="work"),
  E("OBJ-2026-0030","Autoregia","project","personal-vsm","Self-Management","active","critical","system_5_policy","Personal Viable System Model — this very stack.","Run life and work as one regulated system.","Flask server mounting the self-management sub-systems.","self","v0.1","proprietary","https://github.com/dbremont/autoregia","self_hosted","open","api","maintenance","git clone","internal","make deploy-local","high","observational",4.5,["daily-driver","vsm"],0,days(30),pinned=True),
  E("OBJ-2026-0031","A. Castro (Accountant)","person","advisor","Finance","active","medium","system_3_audit_accounting","Personal accountant — tax filings and fiscal advisory.","Keep fiscal obligations timely and optimized.","Annual filings, monthly reconciliation, fiscal advice.","n/a","n/a","n/a","n/a","physical","invitation","none","one_time","n/a","n/a","in-person","high","established",4,["finance","advisor"],90,days(365)),
]
...
RELATIONS = [
    ...
    ("OBJ-2026-0004", "depends_on", "OBJ-2026-0024", "Flask is Python software"),
    ("OBJ-2026-0002", "integrates_with", "OBJ-2026-0024", "Python tooling in the editor"),
    ("OBJ-2026-0009", "integrates_with", "OBJ-2026-0027", "Containers on the NixOS server"),
    ("OBJ-2026-0028", "alternative_to", "OBJ-2026-0009", "Cloud vs self-hosted compute"),
    ("OBJ-2026-0009", "alternative_to", "OBJ-2026-0028", None),
    ("OBJ-2026-0030", "contains", "OBJ-2026-0004", "APIs served by Flask"),
    ("OBJ-2026-0030", "contains", "OBJ-2026-0005", "Charts rendered with ECharts"),
    ("OBJ-2026-0015", "serves", "OBJ-2026-0030", "Pipeline ships Autoregia images"),
    ("OBJ-2026-0008", "complements", "OBJ-2026-0025", "arXiv feeds the paper collection"),
    ("OBJ-2026-0030", "references", "OBJ-2026-0024", "Implemented mostly in Python"),
]
...
ANNOTATIONS_SEED = [
    ...
    ("OBJ-2026-0026", "ann-0007", "self", "question", "Revisit DR bond ladder maturity dates in Q4.", "open", recent(5)),
    ("OBJ-2026-0030", "ann-0008", "self", "review", "Index home redesign shipped; federation view stable.", "resolved", recent(1)),
]
