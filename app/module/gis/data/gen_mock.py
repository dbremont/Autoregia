...
ENTRIES = [
  ...
  E("OBJ-2026-0030","Autoregia","project","personal-vsm","Self-Management","active","critical","system_5_policy","Personal Viable System Model — this very stack.","Run life and work as one regulated system.","Flask server mounting the self-management sub-systems.","self","v0.1","proprietary","https://github.com/dbremont/autoregia","self_hosted","open","api","maintenance","git clone","internal","./run.sh deploy","high","observational",4.5,["daily-driver","vsm"],0,days(30),pinned=True),
